...
变换同时锁定源文件 SHA-256 `80664dc90259b6312ac86259c5a3ccdacbc3b7674600e37f42404aeccc7834f4` 和输出 SHA-256 `4d3f63a63c89cb098246ac80ff38a09f7f9c8e2dc5d5a5ef59d9f8b3f3c4e3bf`。任一端漂移都会阻止生成，不会对未审查新版静默打补丁。文件夹选择、普通文件流式上传、发送引用、设置和清理逻辑保持不变。
