...
| [DSH Native Memory](https://github.com/highland0971/dsh-native-memory) | Persist, retrieve, and approve long-term memory by workspace | Source-code review and rc.6 Profile testing completed for `dsh-native-memory@0.2.0`; install it from the Plugin Center to replace App-owned memory |
